#!/usr/bin/env python3
"""
Скрипт для принудительного перезапуска сервера с очисткой кеша
"""
...
def main():
    print("=== Принудительный перезапуск сервера с очисткой кеша ===")
    ...
    print("Ждем 10 секунд для запуска сервера...")
    time.sleep(10)
